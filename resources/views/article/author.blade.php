                                                            ...
                                                            <div class="wrapped ">
                                                                <div
                                                                    ...
                                                                    <div class="login-title">
                                                                        <h6 style="font-size: 14px;">Author</h6>
                                                                        <h1>{{ $author->name }}</h1>
                                                                    </div>
                                                                    <div class="fit padding inc_5px">
                                                                        @if (count($author->articles) > 0)
                                                                            @foreach($author->articles as $key1 => $article)
                                                                                <div>
                                                                                    ...
                                                                                    <ul>
                                                                                        <li><b>Publish
                                                                                                date</b> {{ $article->publish_date }}
                                                                                        </li>
                                                                                        <li>
                                                                                            <b>Type:</b> {{ $article->type }}
                                                                                        </li>
                                                                                        <li>
                                                                                            <b>Classification:</b> {{ $article->classification->title }}
                                                                                        </li>
                                                                                        <li>
                                                                                    ...
                                                                                    <a target="_blank"
                                                                                       href="{{ route('profile.show', ['id' => $article->id]) }}"><i
                                                                                            class="far fa-list-alt"></i>
                                                                                        More details... </a>
                                                                                    @if ($key1 !== count($author->articles))
                                                                                        <hr/>
                                                                                    @endif
                                                                                </div>
                                                                            @endforeach
                                                                        @else
                                                                            <h2 style="color: red">No articles under
                                                                                this subject yet!</h2>
                                                                        @endif
                                                                    </div>
                                                                </div>
