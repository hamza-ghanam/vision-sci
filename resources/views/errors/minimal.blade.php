                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="wrapped ">
                                                                                                <div
                                                                                                    ...
                                                                                                    @else
                                                                                                        <div
                                                                                                            class="loginBar logged-in"
                                                                                                            tabindex="0">
                                                                                                            <span
                                                                                                                class="fullIndividualName hidden-xs hidden-sm visible-tl ">
                                                                                                                <span
                                                                                                                    class="individualHeading">
                                                                                                                    Hi, {{ auth()->user()->name }} <i
                                                                                                                        class="fas fa-angle-down"
                                                                                                                        style="margin-left: 5px;"></i>
                                                                                                                </span>
                                                                                                                <span
                                                                                                                    class="yourAccountTxt">Your account</span>
                                                                                                            </span>
                                                                                                            <span
                                                                                                                class="hidden-lg hidden-md icon-user hidden-tl individualIcon"></span>
                                        ...
                                        <div class="widget-body body body-none  body-compact-all">
                                            <div class="container-fluid">
                                                <div class="row row-md gutterless ">
                                                    <div class="col-md-12 fit padding inc_5px">
                                                        <div class="contents" data-pb-dropzone="contents0">
                                                            <div
                                                                ...
                                                                <div class="wrapped ">
                                                                    <div class="widget-body body body-none  body-compact-all">
                                                                        <div style="text-align: center">
                                                                            <h1 style="font-size: 84px;">@yield('code')</h1>
                                                                            <p style="font-size: 38px;">@yield('message')</p>
                                                                            <p>
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <ul>
                                                                                                        ...
                                                                                                        <li>
                                                                                                            <a href="{{ route('article.classifications') }}">Articles
                                                                                                                Classifications</a>
                                                                                                        </li>
                                                                                                    </ul>
                                                                                                </div>
                                                                                        ...
                                                                                        <div class="wrapped ">
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <ul>
                                                                                                        <li>
                                                                                                            <a href="{{ route('profile.index') }}">Your
                                                                                                                Articles</a>
                                                                                                        </li>
                                                                                                        <li>
                                                                                                            <a href="{{ route('profile.add') }}">Submit
                                                                                                                a new
                                                                                                                manuscript</a>
                                                                                                        </li>
                                                                                                        <li>
                                                                                                            <a href="{{ route('profile.download', ['id' => 'guidelines']) }}">Download
                                                                                                                our
                                                                                                                guidelines</a>
                                                                                                        </li>
                                                                                                        <li>
                                                                                                            <a href="{{ route('profile.index') }}">Follow-up
                                                                                                                your
                                                                                                                article
                                                                                                                status</a>
                                                                                                        </li>
                                                                                        ...
                                                                                        <div class="wrapped ">
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <ul>
                                                                                                        <li>
                                                                                                            <a href="{{ route('home') }}">My
                                                                                                                Personal
                                                                                                                Info</a>
                                                                                                        </li>
                                                                                                        <li>
                                                                                                            <a href="{{ route('password.request') }}"
                                                                                                               class="footer-ad-click">Reset
                                                                                                                my
                                                                                                                password</a>
                                                                                                        </li>
                                                                                                        <li>
                                    ...
                                    <div class="widget-body body body-none  body-compact-all">
                                        <div class="banner">
                                            ...
                                            <p class="message">We use cookies to improve your website experience. To
                                                ...
                                                settings, please see our <a href="{{ route('cookies') }}">Cookie
                                                    Policy.</a> By
